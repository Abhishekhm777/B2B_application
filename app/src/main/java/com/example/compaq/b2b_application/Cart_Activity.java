...
public class Cart_Activity extends AppCompatActivity {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        try {
                            ...
                            for (int i = 0; i < ja_data.length(); i++) {
                               ...
                               int delete_ids= Integer.parseInt(jsonObject1.getString("id"));
                                ...
                                seller_name(seller,pid,we,qty,delete_ids,description,purity,size,length);
                            }
    ...
    public void seller_name ( final String seller,final String id,final String weght,final String qty,final int del_id,final String description,final String purity,final  String size,final String length){
    ...
    public void display_cart_details(final String id,final String weght,final String qty,final int del_id,final String description,final String purity,final  String size,final String length,final  String seller_name) {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                              ...
                              /*  total_price = (Math.round((total_price + (Double.parseDouble(new_price))) * 100D) / 100D);
                                ...
                                productlist.add(new Cart_recy_model(name, href, weght, product_id, qty,del_id,description,purity,size,length,seller_name));
