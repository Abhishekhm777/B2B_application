 ...
 */
public class Childrens_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_childrens_fragment, container, false);
            ...
            expListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
                ...
                public void onGroupExpand(int groupPosition) {
                    ...
                    if(groupPosition==listDataHeader.size()-1){
                        Log.e("CLicked",String.valueOf(groupPosition));

                        bundle2 = new Bundle();

                        bundle2.putString("Item_Clicked", original);
                    ...
                    if (listDataChild.get(listDataHeader.get(groupPosition)).size() == 0) {
                       ...
                       /* Toast.makeText(getActivity(),
                        ...
                        bundle2.putString("Item_Clicked", original + "," + listDataHeader.get(groupPosition));
                        bundle2.putString("CLASS","FRAGMENT2");
                        Log.e("item_clicked",item_clicked + "," + listDataHeader.get(groupPosition));
