...
import com.example.compaq.b2b_application.Model.JsonModel;
...
public class Seller_Portal_Screen_Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NotificationManager notificationManager = (NotificationManager) Seller_Portal_Screen_Activity.this.getSystemService(Context.NOTIFICATION_SERVICE);
                ...
                notificationBuilder = new NotificationCompat.Builder(Seller_Portal_Screen_Activity.this, CHANNEL_ID)
                        .setSmallIcon(R.mipmap.ic_launcher)
                        .setContentTitle("NOTIFICATION")
                        .setBadgeIconType(R.drawable.ordofy_logggo)
                        .setContentText("Hello");

                Intent notificationIntent = new Intent(Seller_Portal_Screen_Activity.this, Seller_Portal_Screen_Activity.class);
                PendingIntent contentIntent = PendingIntent.getActivity(Seller_Portal_Screen_Activity.this, 0, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
...
linearLayout=(LinearLayout)findViewById(R.id.graphlayout);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Seller_Portal_Screen_Activity.this.finish();
            Intent i = new Intent(this, SellerPortal_Activity.class);
            startActivity(i);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.request) {
            ...
            session.logoutUser(Seller_Portal_Screen_Activity.this);
    ...
    private void requestCameraPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            // Display a SnackBar with cda button to request the missing permission.
                    ...
                    ActivityCompat.requestPermissions(Seller_Portal_Screen_Activity.this,
