...
if(role.equalsIgnoreCase("ROLE_WHOLESALER")) {
    Intent i = new Intent(_context, Seller_Portal_Screen_Activity.class);
    ...
    _context.startActivity(i);
      ...
      if(role.equalsIgnoreCase("ROLE_RETAILER")) {
                Intent i = new Intent(_context, SellerPortal_Activity.class);
                // Closing all the Activities
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
...
try{
    ((SellerPortal_Activity) context).finish();
        ...
        try{
            ((Seller_Portal_Screen_Activity) context).finish();
